        ...
        <header className="sticky top-0 z-40 bg-[#050505]/95 backdrop-blur-md border-b border-white/5">
          <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <a href="#" className="flex flex-col items-start select-none">
              <span className="font-serif text-xl sm:text-3xl font-light tracking-[0.15em] text-[#D4AF37] hover:text-[#F8F5EE] transition-all leading-none uppercase">
                ANANDAPOET
              </span>
              <span className="font-sans text-[8px] sm:text-[10px] tracking-[0.4em] uppercase text-[#D4AF37] font-semibold mt-1.5">
                PERSONAL GALLERY
              </span>
            </a>

            {/* Desktop navigation indices */}
            <nav className="flex items-center gap-6 font-mono text-[9px] uppercase tracking-widest text-[#F8F5EE]/60">
